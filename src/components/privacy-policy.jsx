    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Wisearcs, we are dedicated to safeguarding your privacy and
            ...
            existing agreements directly established between you and Wisearcs.
          ...
          <p className="mb-4">
            At Wisearcs, we will only request personal information when it is
          ...
          <p className="mb-4">
            In the event that Wisearcs invites you to complete and submit an
          ...
          <p className="mb-4">
            It's important to note that while Wisearcs may track a visitor's
          ...
          <p className="mb-4">
            The purposes for which Wisearcs may utilize your personal
          ...
          <p className="mb-4">
            If you wish to be removed from any Wisearcs distribution list,
          ...
          <p className="mb-4">
            ...
            Wisearcs, you may receive telephone calls from us regarding new
          ...
          <p className="mb-4">
            The Wisearcs website may contain links to external websites,
            ...
            are not governed by Wisearcs's privacy policy. Wisearcs has no
          ...
          <p className="mb-4">
            ...
            Wisearcs's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features. Wisearcs
          ...
          <p className="mb-4">
            ...
            paramount at Wisearcs. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Wisearcs, we remain committed to upholding the highest standards
          ...
          <p className="mb-4">
            ...
            Wisearcs remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At Wisearcs, we are committed to maintaining the highest standards
          ...
          <p className="mb-4">
            Wisearcs is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Wisearcs is
          ...
          <p className="mb-4">
            Wisearcs is subject to the investigative and enforcement authority
          ...
          <p className="mb-4">
            Wisearcs reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Wisearcs’s website to stay informed of any updates.
